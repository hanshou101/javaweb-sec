...
public class LDAPReferenceServerTest {
    ...
    public static final String REMOTE_REFERENCE_JAR = RMIReferenceServerTest.url;
    ...
    private static class OperationInterceptor extends InMemoryOperationInterceptor {
        ...
        public void processSearchResult(InMemoryInterceptedSearchResult result) {
            ...
            try {
                ...
                entry.addAttribute("javaClassName", RMIReferenceServerTest.className);
                entry.addAttribute("javaFactory", RMIReferenceServerTest.className);
